...
run: build
	qemu-system-x86_64 -bios bios.bin -boot d -cdrom build/vmbr.iso -drive file=win10.vhd,format=raw -serial stdio --enable-kvm -cpu host -smp 4 -m 2G,maxmem=8G -vga std
...
gef: build
	qemu-system-x86_64 -bios bios.bin -boot d -cdrom build/vmbr.iso -drive file=win10.vhd,format=raw -s -S -serial stdio --enable-kvm -cpu host -smp 4 -m 2G,maxmem=8G & gef

win: win10.vhd
	qemu-system-x86_64 -bios bios.bin -drive file=win10.vhd,format=raw --enable-kvm -smp 1 -cpu host -m 1024,maxmem=8G -vga std
